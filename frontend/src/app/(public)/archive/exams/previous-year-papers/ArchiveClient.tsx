                        ...
                        {isExpanded && (
                          <div className="relative ml-8">
                            ...
                            {(!authLoading && !authUser) && category.entries.length > 5 && (
                              <div className="absolute inset-x-0 bottom-0 h-32 bg-gradient-to-t from-background via-background/90 to-transparent flex flex-col items-center justify-end pb-4 z-10">
