...
export default function ScoringPage() {
    return (
        <div className="bg-background text-text-primary selection:bg-teal-500/30">
            <header className="inconsolata-ui border-b border-border h-[48px] flex items-center px-6 shrink-0 bg-background">
