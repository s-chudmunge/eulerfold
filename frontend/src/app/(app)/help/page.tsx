...
export default function HelpPage() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: 'Roadmap Credits allow you to generate full-scale, premium AI roadmaps. All users get one free credit upon signup. Additional credits can be purchased for ₹99 (includes 2 credits).',
      icon: <Zap className="w-3.5 h-3.5" />
    },
    {
      category: 'Credits',
