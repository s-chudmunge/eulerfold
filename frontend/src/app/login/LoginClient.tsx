        ...
        <div className="min-h-screen bg-background text-text-primary flex flex-col selection:bg-teal-500/30 overflow-y-auto overflow-x-hidden scroll-smooth relative">
            ...
            <main className="min-h-screen flex flex-col items-center justify-center p-6 py-20">
                <div className="w-full max-w-[320px] animate-in fade-in zoom-in-95 duration-500 flex flex-col items-center">
                    ...
                    {isSuccess ? (
                        <div className="w-full bg-white dark:bg-white/[0.03] border border-border rounded-3xl p-8 shadow-sm flex flex-col items-center text-center animate-in fade-in zoom-in-95 duration-500">
                            ...
                            <h2 className="text-xl font-bold text-text-heading mb-3 manrope-body">
                                Check your inbox!
                            </h2>
                            <p className="text-text-muted text-[13px] leading-relaxed manrope-body px-2">
                                An email to activate your account has been sent to <span className="font-bold text-text-primary">{email}</span>. It may take a few minutes to arrive.
                            </p>
                            <button 
                                onClick={() => setIsSuccess(false)}
                                className="mt-8 text-[10px] font-bold text-accent hover:underline uppercase tracking-widest transition-colors h-8"
                            >
                                Back to login
                            </button>
                        </div>
