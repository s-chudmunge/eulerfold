...
export default function SkillGapClient() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background font-sans selection:bg-accent/20">
      ...
      {isRedirecting && (
        <div className="fixed inset-0 z-[200] bg-background/95 backdrop-blur-md flex flex-col items-center justify-center animate-in fade-in duration-500">
          <div className="flex flex-col items-center gap-6">
            <div className="flex flex-col items-center gap-4">
              <p className="text-[14px] font-bold text-text-heading tracking-wider">
      ...
      <main className="flex-1 min-w-0 bg-background relative overflow-hidden">
        ...
        <section className="pt-24 pb-16 md:pt-32 md:pb-24 px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <span className="text-accent">Knowledge Gaps</span>
            </motion.h1>
            ...
            >
              Take a targeted diagnostic assessment. Based on what you get wrong, we build a custom course focused on fixing your weak spots and accelerating your mastery.
            </motion.p>
            ...
            >
              <div className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-accent" /> Dynamic Quiz Generation</div>
              <div className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-accent" /> Precision Targeting</div>
              <div className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-accent" /> Skips What You Know</div>
            </motion.div>
          </div>
        </section>
        ...
        <section className="py-12 px-6 relative z-10 border-t border-border/30 bg-sidebar/20">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[1fr_minmax(auto,42rem)_1fr] gap-12">
            ...
            <div className="order-2 w-full mx-auto relative">
              <div className="absolute -inset-1 bg-accent/10 rounded-lg blur-xl opacity-50"></div>
              <KnowledgeGapQuiz onRoadmapGenerated={handleRoadmapGenerated} />
            </div>

            <div className="order-3 hidden lg:flex flex-col gap-6 mt-8">
              <div className="bg-background border border-border p-6 rounded-lg shadow-xs hover:border-accent/40 transition-colors">
                <BrainCircuit className="w-6 h-6 text-accent mb-4" />
                <h3 className="text-[14px] font-bold text-text-heading mb-2">Adaptive Questions</h3>
                <p className="text-[12px] text-text-muted leading-relaxed">
                  The AI generates scenario-based questions to deeply probe your understanding of a given topic.
                </p>
              </div>
              <div className="bg-background border border-border p-6 rounded-lg shadow-xs hover:border-accent/40 transition-colors">
                ...
                <p className="text-[12px] text-text-muted leading-relaxed">
                  Avoid re-learning what you already know. The resulting roadmap is focused on your blind spots.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 md:py-24 px-6 bg-background border-t border-border/30 relative z-10">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-[14px] font-bold text-accent tracking-wider text-center mb-12 md:mb-16">Frequently Asked Questions</h2>
            <FAQAccordion 
              items={[
                {
                  question: "How many questions are in the quiz?",
                  answer: "Typically 5 multiple choice questions. They are dynamically generated based on your target role and stated experience level."
                },
                {
                  question: "What if I get everything right?",
                  answer: "If you demonstrate mastery across the board, the AI will generate an advanced roadmap designed to push your skills even further."
                },
                {
                  question: "Why take a quiz first?",
                  answer: "Diagnostic auditing prevents you from re-learning concepts you already know. It ensures the resulting curriculum is focused on your actual blind spots."
                }
              ]}
            />
          </div>
