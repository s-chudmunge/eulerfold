...
const ResearchPilot: React.FC<ResearchPilotProps> = ({ initialContent, onSave, lastSaved }) => {
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-background animate-in fade-in duration-500">
      {/* Research Toolbar */}
      <div className="h-14 border-b border-border flex items-center justify-between px-6 bg-sidebar/20">
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-2">
            <FileText className="w-4 h-4 text-teal-700 opacity-60" />
            <span className="inconsolata-ui text-[11px] font-bold text-text-heading tracking-tight">Editor</span>
          </div>
          <div className="h-4 w-[1px] bg-border" />
          <div className="flex items-center gap-4">
             <button className="p-1.5 hover:bg-background rounded-none text-text-muted hover:text-text-heading transition-colors" title="Formatting">
                <Type className="w-4 h-4" />
             </button>
             <button className="p-1.5 hover:bg-background rounded-none text-text-muted hover:text-text-heading transition-colors" title="List">
                <List className="w-4 h-4" />
             </button>
             <button className="p-1.5 hover:bg-background rounded-none text-text-muted hover:text-text-heading transition-colors" title="Blockquote">
                <Quote className="w-4 h-4" />
             </button>
             <button className="p-1.5 hover:bg-background rounded-none text-text-muted hover:text-text-heading transition-colors" title="Reference">
        ...
        <div className="flex items-center gap-4">
           ...
           <button 
             ...
             className="flex items-center gap-2 px-4 py-1.5 bg-background border border-border rounded-none text-[11px] font-bold text-text-heading hover:border-teal-700/50 transition-all shadow-sm uppercase tracking-widest"
           >
