...
export default function AnnouncementBar() {
  ...
  return (
    <div className="fixed top-0 inset-x-0 z-[70] bg-gradient-to-r from-teal-900 via-teal-700 to-teal-900 text-white h-[32px] flex items-center px-4 md:px-6 transition-all animate-in fade-in slide-in-from-top duration-300 border-b border-white/10 shadow-sm">
