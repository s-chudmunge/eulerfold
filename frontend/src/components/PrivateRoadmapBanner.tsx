        ...
        <div className="flex flex-wrap items-center gap-x-6 gap-y-2 text-text-muted text-[12px] md:text-[13px] font-medium">
          {(authorName || username) && (
            <div className="flex items-center gap-2">
              ...
              {username ? (
                <Link href={`/u/${username}`} className="flex items-center gap-1.5 hover:text-text-primary transition-colors group">
                  <img 
                      ...
                      className="w-5 h-5 rounded-full border border-border object-cover transition-colors shadow-sm"
                  />
                  <span className="font-bold underline-offset-4 group-hover:underline text-text-heading">{authorName || username}</span>
                </Link>
              ) : (
                <span className="flex items-center gap-1.5">
                  <img 
                      ...
                      alt={authorName || "User"}
                      className="w-5 h-5 rounded-full border border-border object-cover shadow-sm"
                  />
                  <span className="font-bold text-text-heading">{authorName || username}</span>
                </span>
              )}
            </div>
          )}
        ...
        <div className="flex flex-wrap items-center gap-3 mt-2">
          {isAuthenticated ? (
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3">
              ...
              <span className="text-[12px] font-medium text-text-muted mx-2">to start learning</span>
            </div>
          )}
