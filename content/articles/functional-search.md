---
title: "What is Functional Search?"
...
excerpt: "Searching the map of life. How AI uses the 'biological latent space' to find proteins and molecules with the exact properties we need."
technicalInsight: "Functional search utilizes high-dimensional vector embeddings to perform similarity searches across diverse biological sequences, identifying distant relatives with shared functional motifs."
faq:
...
## The Biological Latent Space {#latent-space}
...
- Enzymes that break down sugars cluster together.
Even if two proteins come from different kingdoms of life (e.g., a human and a deep-sea vent bacterium), if they do the same job, they will be "neighbors" in the latent space.

## Finding the "Unfindable" {#unfindable}
...
## Metagenomic Mining: Searching the Unknown {#metagenomics}
...
## Structure-Aware Search: Foldseek {#foldseek}
...
## Applications: From Medicine to Sustainability {#applications}

1. **Antibiotic Discovery:** Searching the genomes of soil bacteria to find novel "chemical weapons" they use against competitors, which could become our next generation of antibiotics.
2. **Climate Tech:** Finding enzymes that can capture CO2 more efficiently than current industrial processes.
3. **Biomanufacturing:** Finding natural catalysts to replace expensive and toxic chemical processes in factories.

## The Future: Natural Language for Biology {#future}
