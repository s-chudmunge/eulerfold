...
excerpt: "Mary Lou Jepsen's journey from designing screens at Facebook and Google to building a wearable 'MRI' that uses light to see inside the brain."
technicalInsight: "Openwater's technology uses holographic patterns and ultrasound to overcome the scattering of light in biological tissue, enabling high-resolution non-invasive imaging."
synonyms:
  - "Mary Lou Jepsen"
  - "Openwater"
  - "Holography"
