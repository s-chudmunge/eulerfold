...
## Mathematical Existence via Fixed-Point Theorems {#fixed-point-theorem}
...
## The Logic of Mixed Strategies {#mixed-strategies}
...
## Best-Response Correspondence and System Stability {#best-response}
...
## Non-Cooperative Models and Decentralized Order {#non-cooperative-shift}
...
## The Gap Between Individual Rationality and Social Optimality {#optimality-gap}
...
## The Framework of Strategic Persistence {#legacy}
...
- [Equilibrium Points in N-Person Games (PDF)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC1063129/pdf/pnas01548-0050.pdf) {type: docs, provider: NIH PubMed Central}
- [Official Journal Record (DOI)](https://doi.org/10.1073/pnas.36.1.48) {type: docs, provider: PNAS}
- [Game Theory Introduction (Stanford)](https://plato.stanford.edu/entries/game-theory/) {type: article, provider: Stanford Encyclopedia}
- [The Nash Equilibrium (Video)](https://www.youtube.com/watch?v=0i7p9S6W_Is) {type: video, provider: Yale Courses}
