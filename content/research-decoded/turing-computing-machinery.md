...
## The Universal Machine and Discrete States {#universal-machine}
...
## Logical and Mathematical Constraints {#mathematical-objections}
...
## The Operationalist View of Consciousness {#consciousness-argument}
...
## Lady Lovelace’s Objection and Algorithmic Autonomy {#lovelace-objection}
...
## The Child Machine and Learning Systems {#learning-machine}
...
## The Transformation of Intelligence {#future-implication}
...
- [Computing Machinery and Intelligence (PDF)](https://courses.cs.umbc.edu/graduate/671/fall05/turing.pdf) {type: docs, provider: UMBC}
- [Official Journal Record (DOI)](https://doi.org/10.1093/mind/LIX.236.433) {type: docs, provider: Oxford Mind}
- [The Imitation Game (Video)](https://www.youtube.com/watch?v=3wLqsRLvV-c) {type: video, provider: Computerphile}
