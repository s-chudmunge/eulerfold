---
title: "Watson-Crick Double Helix: Molecular Structure of Deoxyribose Nucleic Acid"
...
## Antiparallel Geometry and the Phosphate Backbone {#backbone-geometry}
...
## X-Ray Diffraction and Structural Boundary Conditions {#photo-51}
...
## Tautomeric Forms and the Specificity of Base Pairing {#base-pairing}
...
## Structural Justification for Chargaff's Rules {#chargaff-rules}
...
## The Mechanism of Semi-Conservative Replication {#copying-mechanism}
...
## The Logic of the Molecular Alphabet {#digital-nature-of-life}
...
- [Molecular Structure of Nucleic Acids (NIH Archive)](https://profiles.nlm.nih.gov/spotlight/sc/catalog/nlm:nlmuid-101584582X381-doc) {type: docs, provider: NIH}
- [Nature Journal Record](https://www.nature.com/articles/171737a0) {type: article, provider: Nature}
- [DNA Structure Animation](https://www.youtube.com/watch?v=o_-6JXLYS-k) {type: video, provider: HHMI BioInteractive}
